...
<div class="checkout">
    ...
    <div class="_content_site">
        <div class="tw_container">
            ...
            <div class="title_checkout tw_title">
                    <h2>đơn hàng của bạn đã được <br> đặt hàng thành công</h2>
                        <p>Đơn hàng sẽ được gửi tới chậm nhất 3 đến 9 ngày. Theo dõi đơn hàng của bạn bên dưới.
                                    Cảm ơn bạn đã sử dụng dịch vụ mua hàng của chúng tôi.</p>
                    </div>
